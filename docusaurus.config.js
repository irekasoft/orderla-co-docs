...
const config = {
  title: 'Orderla Commerce',
  tagline: 'Complete e-commerce solution for modern businesses',
        ...
        links: [
          ...
          },
          {
            ...
            items: [ 
              {
                label: 'GitHub',
                href: 'https://github.com/irekasoft',
              },
            ],
          },
        ],
        copyright: `Copyright © ${new Date().getFullYear()} Orderla Commerce. All rights reserved.`,
      },
      prism: {
